...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        // $status = "notverified";
        $insert_data="INSERT INTO `Student` (`Name`, `email`, `password`) VALUES ('$name','$email','$encpass')";
        
        $data_check = mysqli_query($con, $insert_data);
        // if($data_check){
        //     $subject = "Email Verification Code";
        //     $message = "Your verification code is $code";
        //     $sender = "From: darpansarda7@gmail.com";
    ...
    if(isset($_POST['change-password'])){
        ...
        if($password !== $cpassword){
            ...
            $encpass = password_hash($password, PASSWORD_DEFAULT);
            $update_pass = "UPDATE student SET code = $code, password = '$encpass' WHERE email = '$email'";
